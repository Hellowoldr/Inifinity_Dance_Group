...
<tr>
<td width="50%"><h2><center><font style="Lucida Handwriting">Delete Your Account</font></center></h2>
<form name="f5" method="post" action="http://localhost/Final Website/delete1.php">
<center>
E-mail address: <input type="text" name="z1"><br> 
